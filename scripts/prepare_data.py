...
def main():
    """Main function for data download and preprocessing pipeline."""
    parser = argparse.ArgumentParser(
        description="Download and preprocess CHF dataset",
...
Examples:
  ...
  python scripts/download_and_preprocess.py --test-size 0.3 --force-download
    ...
    logger.info("="*60)
    logger.info("CHF Data Download and Preprocessing Pipeline")
    logger.info("="*60)
